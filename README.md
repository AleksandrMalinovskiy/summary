...
- Языки программирования/Скриптовые языки:
  ...
  - [Bash](https://github.com/AleksandrMalinovskiy/admins-script);
- Инструменты для создания образов виртуальных машин:
  - [Packer](/стек/packer/Packer.pdf);
- Инструменты управления инфаструктурой:
...
- Контернизация всех процессов в Docker;
...
- Контроль подключения жилых помещений.
...
**Достижения:**
- Выявил часть ошибок в строительной и проектной документации, что впоследствии позволило сдать строительно-монтажные работы тепломеханического оборудования в установленные сроки и без дополнительных затрат для заказчика.
</details>
