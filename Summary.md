...
В ходе обучения  уже получил навыки по следующему стеку технологий: 
Yandex Cloud 
Packer, 
Terraform, 
Ansible, 
...
Готов компенсировать отсутствие большого опыта в сфере IT быстрой обучаемостью и целеустремленностью.\
...
- Настройка разворачивания среды Gitlab разработки на разные сервера(dev, stage, qa, prod);
...
- Развёртывание и управление приложениями в Docker-compose
